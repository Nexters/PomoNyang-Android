...
data class WeeklyFocusTimeTrendModel(
    ...
    val weeklyMaxFocusTime get(): Float = dateToFocusTimeStatistics.maxOfOrNull { it.totalFocusTime.inWholeMinutes }?.toFloat() ?: 0f
    ...
    fun toFixed7DayFocusTrend(): List<Float> {
        ...
        return last7Days.map { date ->
            focusMap[date]?.totalFocusTime?.inWholeMinutes?.toFloat() ?: 0f
        }.toImmutableList()
    }
}
